...
namespace MultitenantPerDb.BackgroundJobs;

/// <summary>
/// Örnek Background Job - Hangfire ile kullanılabilir
/// </summary>
public class ProductBackgroundJob
{
    ...
    public async Task CheckLowStockForAllTenantsAsync()
    {
        ...
        // Tenant listesini al
        var tenantDbContext = scope.ServiceProvider.GetRequiredService<Data.TenantDbContext>();
